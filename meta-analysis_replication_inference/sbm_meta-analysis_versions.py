...
def scon_pool_init_meta(I_S, I_D, varying_system_parameters, constant_system_parameters, C_t0, SDE_system):
    ...
    For SCON, varying system parameters need to be ordered by Ea_S, Ea_D, Ea_M, a_{SD}, a_{DS}, a_M, and a_{MSC} values. Constant system parameters need to be ordered by u_M values. Pre-warming values in the C_t0 array/vector/tensor need to be ordered by S_0, D_0, and M_0.

    For AWB, varying system parameters need to be ordered by ... values. Constant system parameters need to be ordered by ... values. Pre-warming values in the C_t0 array/vector/tensor need to be ordered by S_0, D_0, M_0, and E_0 values.
    '''
